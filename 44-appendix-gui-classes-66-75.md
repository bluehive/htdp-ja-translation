...
パッケージ `gui-lib` のバージョン 1.58 で変更: Added the color argument.
...
パッケージ `gui-lib` のバージョン 1.58 で追加。
バージョン 1.71 で変更: Added support for setting the color to the system default.
...
パッケージ `gui-lib` のバージョン 1.1 で変更: Added mod3-down, mod4-down, and mod5-down.
...
パッケージ `snip-lib` のバージョン 1.63 で変更: Added the a optional argument.
...
パッケージ `gui-lib` のバージョン 1.3 で変更: Changed the placement strategy to
...
パッケージ `gui-lib` のバージョン 1.25 で変更: Added 'hide-vscroll and 'hide-hscroll.
