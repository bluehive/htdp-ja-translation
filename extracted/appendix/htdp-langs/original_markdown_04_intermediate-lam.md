...
<!-- Source URL path: /htdp-langs/intermediate-lam.html -->
<!-- Canonical English source for Japanese appendix translation -->

<!-- Extracted from appendix_original_html/htdp-langs/intermediate-lam.html -->
...
In ISL and up: append also works when applied to one list or none.
...
Although the *Intermediate Student with Lambda* provides
the for-each function, it is intended to be used
in the Advanced Student level.
