...
パッケージ `snip-lib` のバージョン 1.1 で変更: Added the backing-scale argument.
...
バージョン 1.2 で変更: Added control+meta-is-altgr.
...
パッケージ `gui-lib` のバージョン 6.1.0.8 で変更: Changed reporting of numpad Enter
to 'numpad-enter as
...
パッケージ `gui-lib` のバージョン 1.2 で変更: Added g: and ~g: support.
